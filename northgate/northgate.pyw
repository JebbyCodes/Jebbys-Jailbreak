...
def pink():
    ...
    creditsbutton.config(font=("harrington 24 bold"), bg="#ff8ad4", fg="white", activebackground="#ffe0f4", activeforeground="purple", borderwidth=0, width=19)
    title7.config(bg="#ffc9eb", fg="#ff8ad4")
    output2.config(borderwidth=0, fg = "purple", bg = "#ffc9eb", font='arial 13')
    myframe2['bg']='#ffc9eb'
    myframe['bg']='#ffc9eb'
    wrapper['bg']='#ffc9eb'
    root['bg']='#ffc9eb'
    ...
    button2.config(fg = "white", bg = "#ff8ad4", activebackground="#ffc9eb", activeforeground="purple", borderwidth=0)
    button3.config(fg = "white", bg = "#ff8ad4", activebackground="#ffc9eb", activeforeground="purple", borderwidth=0)
    ...
    fetchExebutton3.config(font=("arial 15"), bg="#ff8ad4", fg="white", activebackground="#ffe0f4", activeforeground="purple", borderwidth=0)
    fetchExebutton2.config(font=("arial 15"), bg="#ff8ad4", fg="white", activebackground="#ffe0f4", activeforeground="purple", borderwidth=0)
    fetchExebutton1.config(font=("arial 15"), bg="#ff8ad4", fg="white", activebackground="#ffe0f4", activeforeground="purple", borderwidth=0)
    entry.config(font=("arial 20"), bg="#ffc9eb", fg="purple", borderwidth=0)
    entry2.config(font=("arial 20"), bg="#ffc9eb", fg="purple", borderwidth=0)
    entry3.config(font=("arial 20"), bg="#ffc9eb", fg="purple", borderwidth=0)
    entry4.config(font=("arial 20"), bg="#ffc9eb", fg="purple", borderwidth=0)
    ...
    fetchWifibutton.config(font=("harrington 24 bold"), bg="#ff8ad4", fg="white", activebackground="#ffe0f4", activeforeground="purple", borderwidth=0, width=19)   
    fetchInfobutton.config(font=("harrington 24 bold"), bg="#ff8ad4", fg="white", activebackground="#ffe0f4", activeforeground="purple", borderwidth=0, width=19)
    fetchExebutton.config(font=("harrington 24 bold"), bg="#ff8ad4", fg="white", activebackground="#ffe0f4", activeforeground="purple", borderwidth=0, width=19)
    corianderbutton.config(font=("harrington 24 bold"), bg="#ff8ad4", fg="white", activebackground="#ffe0f4", activeforeground="purple", borderwidth=0, width=19)
    jebbybutton.config(font=("harrington 24 bold"), bg="#ff8ad4", fg="white", activebackground="#ffe0f4", activeforeground="purple", borderwidth=0, width=19)
    wallpaperbutton.config(font=("harrington 24 bold"), bg="#ff8ad4", fg="white", activebackground="#ffe0f4", activeforeground="purple", borderwidth=0, width=19)
    canvasMain.pack_forget()
    powershellbutton.config(font=("harrington 24 bold"), bg="#ff8ad4", fg="white", activebackground="#ffe0f4", activeforeground="purple", borderwidth=0, width=19)
    lightbutton.config(bg="white", activebackground="gainsboro")
    darkbutton.config(bg="#212121", activebackground="#474747")
    root.config(borderwidth=0)

pinkbutton=Button(myframe, text="♡ Slovenian Theme ♡", font=("harrington 24 bold"), bg="#ff8ad4", fg="white", activebackground="#ffe0f4", activeforeground="purple", borderwidth=0, command=pink, width=19)
pinkbutton.pack(padx=int(width/100), pady=0)0)
...
def pet():
    ...
    def on_mouse_press(evt):
        ...
        bg2 = tk.PhotoImage(master=window, file="skin2.png")
        buttonframe.configure(image=bg2)
        buttonframe.image = bg2
        buttonframe.pack(fill=tk.BOTH, expand=True)
        buttonframe.bind('<B1-Motion>', on_mouse_drag)
    ...
    def on_mouse_release(evt):
        ...
        bg = tk.PhotoImage(master=window, file="skin1.png")
        buttonframe.configure(image=bg)
        buttonframe.image = bg

    buttonframe.bind('<ButtonRelease-1>', on_mouse_release)
    buttonframe.bind('<B1-Motion>', on_mouse_drag)
    buttonframe.bind('<ButtonPress-1>', on_mouse_press)
